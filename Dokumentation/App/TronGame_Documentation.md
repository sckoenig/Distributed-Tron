...
| UC-2   | `playGame(playerNumber : int) : void`                                                                               | ITronModel | Der GameManager wurde initialisiert. | TODO                                  | Der Initiator des Spiels registriert sich beim game mit der Anzahl der von ihm gemanagten Spielern.                                          | Wenn der ModelState sich nicht im Status MENU befindet, erfolgt keine Registrierung.           |
