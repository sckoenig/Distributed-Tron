...
| UC | Funktion                         | Objekt    |Vorbedingung | Nachbedingung | Ablaufsemantik                                                                              |Fehlersemantik|
| ---- |----------------------------------|-----------|----------- |----------- |---------------------------------------------------------------------------------------------|----------- |
| | `start() : void`                 | IReceiver |  |   |                                                                                             |    |
| | `stop() : void`                  | IReceiver |  |   |                                                                                             |    |
| | `createReceiverSockets() : void` | Receiver  |  |   | Es werden zuhörende Sockets mit zufälligen Ports erstellt.                                  |    |
| | `startTcpReceiver() : void`      | Receiver  |  |   | Es wird ein Thread gestartet zum bearbeiten des Tcp Server Sockets.                         |    |
| | `startTcpSocketHandler() : void` | Receiver  |  |   | Es wird ein Thread gestartet der die ankommenden Sockets des Tcp Server Sockets bearbeitet. |    |
| | `startUdpReceiver() : void`      | Receiver  |  |   | Es wird ein Thread für die Udp Datagrams erstellt.                                          |    |
...
| | `addToQueue(message : byte[]) : void`                                                                                     | IUnmarshaller            | Message ist nicht NULL.                    | Message ist unmarshalled.                                      | Fügen die übergebene message in die unmarshaller queue.                                     |    |
| | `startServiceCallHandler() : void`                                                                                        | Unmarshaller             | In der queue ist eine Message.             |                                                                | Startet einen Thread der die Nachrichten in der unmarshaller queue bearbeitet.              |    |
| | `stop() : void`                                                                                                           | IUnmarshaller            |                                            | Der Unmarshaller Thread ist gestoppt.                          | Stoppt den Unmarshaller Thread.                                                             |    |
...
| | `sendRequest(messageType : byte, serviceId : int, remoteId : String, address : String, awaitResponse : boolean) : String` | NameResolver   |                                                                                                           |                                                                         | Sendet eine Nachricht an den NameServer und gibt die Antwort zurück, wenn es keine Antwort gibt, wird ein leerer String zurückgegeben. |    |
| | `startClearCache() : void`                                                                                                | NameResolver   |                                                                                                           |                                                                         | In regulären Abständen wird der Cache geleert.                                                                                         |    |
| | `start() : void`                                                                                                          | NameServer     | Der NameServer wurd noch nicht gestartet.                                                                 | Der NameServer läuft.                                                   | Startet den NameServer.                                                                                                                |    |
| | `runServerSocket() : void`                                                                                                | NameServer     |                                                                                                           |                                                                         | Startete den ServerSocket und waret auf eingehende Nachrichten.                                                                        |    |
| | `processMessage(message : NamingServiceMessage, clientSocket : Socket) : void`                                            | NameServer     |                                                                                                           |                                                                         | Verarbeitet eine eingehende Nachricht.                                                                                                 |    |
| | `stop() : void`                                                                                                           | NameServer     | Der NameServer läuft.                                                                                     | Der NameServer ist gestoppt.                                            | Stopt den NameServer.                                                                                                                  |    |
| | `lookUpCache(remoteId : String, serviceId : int) : String`                                                                | NameResolver   |                                                                                                           |                                                                         | Im Cache wird nach den Informationen gesucht, wenn sie im ache nicht gefunden werden, wird NULL zurückgegeben.                         |    |
